...
//await t.pass(complianceAddress);
...
(0, _ava2.default)('Checks if subscription is permitted', async t => {
  ...
  t.truthy(_rec._expr(_rec._capt(x, 'arguments/0'), {
    content: 't.truthy(x)',
    filepath: 'test/complianceModule1.test.js',
    line: 60,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"truthy","range":[2,8]},"computed":false,"range":[0,8]},"arguments":[{"type":"Identifier","name":"x","range":[9,10]}],"range":[0,11]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"truthy","range":[2,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"x","range":[9,10]},{"type":{"label":")"},"range":[10,11]}]',
...
(0, _ava2.default)('Checks if redemption permitted', async t => {
  ...
  t.truthy(_rec2._expr(_rec2._capt(y, 'arguments/0'), {
    content: 't.truthy(y)',
    filepath: 'test/complianceModule1.test.js',
    line: 68,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"truthy","range":[2,8]},"computed":false,"range":[0,8]},"arguments":[{"type":"Identifier","name":"y","range":[9,10]}],"range":[0,11]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"truthy","range":[2,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"y","range":[9,10]},{"type":{"label":")"},"range":[10,11]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
});
//# sourceMappingURL=/Users/kareem/melonChallenge/node_modules/.cache/ava/0f4d8bf499458085fdb54aaf84057703.js.map